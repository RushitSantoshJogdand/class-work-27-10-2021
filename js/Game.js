class Game {
 ...
 start(){
  ...
  this.addSprites(life, 4, lifeImage, 0.02);
  this.addSprites(powerCoins, 18, powerCoinImg, 0.09);
  this.addSprites(obstacles, obstaclesPosition.length, obstacleImg1, 0.04, obstaclesPosition);
 }
 ...
 showFuelBar(){
   ...
   fill("#ffc400");
   rect(width/2-100, height-player.positionY-350, player.fuels, 20);
   noStroke();
   pop(); 
  }
 ...
 handlePowerCoins(index){
  ...
  showRank(){
    swal({
      title:`Awesome!${"\n"}Rank${"\n"}${player.rank}`, 
      text:"You Have Reached The Sucessfuly",
